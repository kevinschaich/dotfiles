...
function loadConfiguration(context) {
    const section = vscode_1.workspace.getConfiguration('npm');
    if (section) {
        validationEnabled = section.get('validate.enable', true);
    }
...
function validateDocument(document) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!validationEnabled || (yield isYarnManaged())) {
            diagnosticCollection.clear();
            return;
        }
...
function getInstalledModules(package_dir) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            if (!package_dir) {
                package_dir = vscode_1.workspace.rootPath;
            }
...
function getIncludedDirectories() {
    ...
    if (vscode_1.workspace.getConfiguration('npm')['includeDirectories'].length > 0) {
        for (const dir of vscode_1.workspace.getConfiguration('npm')['includeDirectories']) {
