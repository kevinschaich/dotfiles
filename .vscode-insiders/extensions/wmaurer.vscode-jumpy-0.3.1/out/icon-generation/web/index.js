...
//                     resolve({
//                         code,
//                         jpegEncoded: canvas.toDataURL('image/jpeg', 1.0)
//                     })
...
//     return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 13" height="13" width="14"><rect width="14" height="13" rx="2" ry="2" style="fill: ${backgroundColor};"></rect><text font-family="Consolas" font-size="11px" fill="${fontColor}" x="1" y="10">${code}</text></svg>`;
// }
